...
import { QUESTIONS, EPILOGUES } from './data/adventure';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-900 via-black to-black flex items-center justify-center p-4 font-sans text-gray-200 overflow-hidden">
      <div className="w-full max-w-4xl animate-fadeIn">
        ...
        {!state.isFinished && !currentQuestion && (
           <div className="text-center">
             <h1 className="text-3xl font-bold mb-4">Ein Fehler ist aufgetreten oder das Abenteuer ist zu Ende.</h1>
             <button onClick={resetGame} className="px-6 py-2 bg-gray-700 rounded hover:bg-gray-600 transition-colors">Neustart</button>
           </div>
        )}
      </div>
    </div>
